                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12 text-right">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 mb-2">
                                <input type="email" name="cus_email" class="form-control" placeholder=" Customer Email">

                            </div>
                            <div class="col-md-3 col-sm-12 mb-2">
                                <input type="text" name="cus_no" class="form-control" placeholder=" Customer Number">
                    ...
                    <div class="col-12 add_purchase_order_notify"></div>
                </div>
            </div>
...
@section('scripts')
    ...
    {{-- <script>
        $(document).ready(function() {
            $(document).on("submit", "#add_purchase_order_form", function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == "true") {
                            $(".add_purchase_order_notify").html(
